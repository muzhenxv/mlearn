...
class TransformerTest(unittest.TestCase):  # 继承unittest.TestCase
    def tearDown(self):
        # 每个测试用例执行之后做操作
        pass
    ...
    def test_Transformer(self):
        for dict in transformer_params:
            json_str = json.dumps(dict)
            # print(json_str, '\n')
            res = mlearn.transformer_ui(json_str)
            # print(res, '\n')
            msg = json_str + '\n\n\n\n' + res
...
if __name__ == '__main__':
    ...
    report_title = 'TransformerTest用例执行报告'
    desc = ''
